...
function SocialDesktop() {
  return (
    <>
      <div className="absolute right-[-60px] top-[135px] hidden h-[60px] w-[250px] items-center justify-between gap-4 rounded-xl bg-veryDarkGrayishBlue  px-8 py-4 drop-shadow-xl md:flex lg:top-[125px]">
        <span className="text-sm uppercase tracking-[0.25rem] text-grayishBlue">
          Share
        </span>
      ...
      <div className="triangle absolute right-[45px] top-[190px] hidden drop-shadow-xl md:block lg:top-[180px]"></div>
    </>
  );
}
