...
function SocialMobile() {
  return (
    <div className="absolute bottom-0 right-0 left-0 flex h-[75px] items-center justify-between gap-4 rounded-b-lg bg-veryDarkGrayishBlue px-8 py-4 md:hidden">
      ...
      <div className=" ml-auto rounded-full bg-desaturatedDarkBlue p-2">
